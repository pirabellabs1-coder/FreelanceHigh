...
export function AdminHeader({ onMobileMenu }: { onMobileMenu: () => void }) {
  return (
    <header className="h-14 border-b border-border-dark flex items-center justify-between px-6 shrink-0 bg-neutral-dark/50">
      ...
      <div className="flex items-center gap-2">
        <span className="flex items-center gap-1.5 bg-emerald-500/10 text-emerald-400 px-2.5 py-1 rounded-full text-[10px] font-bold">
        ...
        <Link href="/admin" className="flex items-center gap-2 ml-2 px-2 py-1.5 rounded-xl hover:bg-border-dark/50 transition-colors">
