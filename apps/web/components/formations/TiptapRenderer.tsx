  ...
  return (
    <div
      className={`prose prose-sm dark:prose-invert max-w-none
        ...
        [&_th]:border [&_th]:border-slate-300 [&_th]:dark:border-slate-600 [&_th]:bg-slate-100 [&_th]:dark:bg-slate-800 [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_th]:font-semibold [&_th]:text-sm
        [&_td]:border [&_td]:border-slate-200 [&_td]:dark:border-slate-700 [&_td]:px-3 [&_td]:py-2 [&_td]:text-sm
