  ...
  return (
    <div className="flex min-h-0 flex-1">
      ...
      <MobileSidebarOverlay open={mobileOpen} onClose={() => setMobileOpen(false)}>
        <aside className="h-full bg-white dark:bg-slate-900 dark:bg-neutral-dark border-r border-slate-200 dark:border-slate-700 dark:border-border-dark flex flex-col">
          <div className="flex items-center p-4 border-b border-slate-200 dark:border-slate-700 dark:border-border-dark">
