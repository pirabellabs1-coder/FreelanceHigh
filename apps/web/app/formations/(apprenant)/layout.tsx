    ...
    <div className="flex min-h-[calc(100vh-200px)]">
      ...
      >
        ...
        <button
          ...
          className={cn(
            "absolute top-5 -right-3 z-10 w-6 h-6 bg-white dark:bg-neutral-dark border border-slate-200 dark:border-border-dark rounded-full shadow-md flex items-center justify-center text-slate-400 hover:text-primary transition-colors"
          )}
          ...
          <nav className="flex items-center text-sm text-slate-500">
            ...
            {breadcrumbSegments.map((segment, i) => (
              <span key={i} className="flex items-center">
                ...
                <span className={i === breadcrumbSegments.length - 1 ? "font-semibold text-slate-900 dark:text-slate-100" : ""}>
