...
export async function GET(request: Request) {
  ...
  // Production: no WorkSession model in schema yet — return empty list
  // TODO: add WorkSession model to schema for persistent productivity tracking
...
export async function POST(request: Request) {
  ...
  // Production: no WorkSession model in schema yet
  // TODO: add WorkSession model to schema for persistent productivity tracking
