  ...
  try {
    ...
    return NextResponse.json({
      candidatures: bids.map((b) => ({
        ...
        name: (b as any).freelance?.name || "",
        freelanceName: (b as any).freelance?.name || "",
        freelanceTitle: (b as any).freelance?.freelancerProfile?.title || "",
        country: (b as any).freelance?.country || "",
        rating: 0,
        amount: b.amount,
