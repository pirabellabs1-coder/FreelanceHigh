  ...
  return (
    <div className="p-5 md:p-8 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <Link
          href="/formations/vendeur/statistiques"
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <ToolCard
            href="/formations/vendeur/marketing/codes-promo"
            icon="local_offer"
            iconBg="bg-amber-50"
          ...
          />
          <ToolCard
            href="/formations/vendeur/marketing/popups"
            icon="ads_click"
            iconBg="bg-pink-50"
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          />
          <ToolCard
            href="/formations/vendeur/marketing/campagnes"
            icon="link"
            iconBg="bg-teal-50"
