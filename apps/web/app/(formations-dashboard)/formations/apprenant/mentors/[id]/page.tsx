...
export default function MentorBookingPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
      <div className="p-5 md:p-8 max-w-lg mx-auto text-center py-16">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/formations/apprenant/mentors" className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl border border-gray-200 text-sm font-semibold text-[#191c1e] hover:bg-gray-50 transition-colors bg-white">
            Voir mes sessions
          </Link>
          <Link href="/formations/explorer" className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-white text-sm font-bold hover:opacity-90 transition-opacity" style={{ background: "linear-gradient(to right, #006e2f, #22c55e)" }}>
  ...
  return (
    <div className="p-5 md:p-8 max-w-5xl mx-auto">
      {/* Back */}
      <Link href="/formations/apprenant/mentors" className="inline-flex items-center gap-1.5 text-sm text-[#5c647a] hover:text-[#006e2f] font-medium mb-6 transition-colors group">
