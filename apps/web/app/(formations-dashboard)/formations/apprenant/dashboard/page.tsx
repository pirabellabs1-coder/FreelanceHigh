          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex-1 p-5 md:p-6">
                ...
                <Link href={`/formations/apprenant/formation/${lastEnrollment.id}`}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/formations/apprenant/depenses" className="text-xs text-[#006e2f] font-semibold hover:underline">Voir tout</Link>
          </div>
      ...
      {!isLoading && recent.length > 0 && (
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/formations/apprenant/mes-formations" className="text-xs text-[#006e2f] font-semibold hover:underline flex items-center gap-1">
              Voir tout <span className="material-symbols-outlined text-[14px]">arrow_forward</span>
            </Link>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {recent.map((e) => (
              <Link key={e.id} href={`/formations/apprenant/formation/${e.id}`}
