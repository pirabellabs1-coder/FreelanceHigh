    ...
    try {
      ...
      if (password) {
        ...
        if (signInResult?.error) {
          ...
          router.push(`/formations/connexion?callbackUrl=${encodeURIComponent(callbackUrl)}&verified=1`);
          return;
        }
        ...
        router.push(`/formations/connexion?email=${encodeURIComponent(email)}&verified=1`);
      }
    } catch {
    ...
    <div className="min-h-[calc(100vh-96px)] flex items-center justify-center px-5 py-10 bg-[#f7f9fb]">
      <div className="w-full max-w-md">
        ...
        <div className="mt-5 text-center space-y-2">
          ...
          <Link href="/formations/connexion" className="text-xs text-[#5c647a] hover:text-[#006e2f] transition-colors">
