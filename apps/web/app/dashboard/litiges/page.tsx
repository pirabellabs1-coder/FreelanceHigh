...
const DEMO_DISPUTES: Dispute[] = [
  {
    ...
    clientAvatar: "PM",
    serviceTitle: "Logo Design Moderne",
    amount: 135,
    status: "en_cours",
    openedAt: "2026-02-20",
    reason: "Livraison non conforme au brief initial",
    verdict: null,
    orderId: "ORD-1012",
    timeline: [
      {
        ...
        type: "opened",
        title: "Litige ouvert",
        description: "Le client a ouvert un litige pour non-conformite de la livraison.",
      ...
      },
      {
        id: "tl2",
        type: "message",
        title: "Reponse du freelance",
        description: "Vous avez repondu au litige avec des preuves de conformite.",
      ...
      },
      {
        ...
        description: "Le client a soumis des captures d'ecran du brief original.",
      ...
      },
      {
        id: "tl4",
        type: "jury_assigned",
        title: "Mediateur assigne",
        description: "Un mediateur FreelanceHigh a ete assigne a votre litige.",
    ...
    messages: [
      {
        ...
        content: "La livraison ne correspond pas du tout au brief. Les couleurs et la typographie ne sont pas celles demandees.",
      ...
      },
      {
        ...
        sender: "freelance",
        senderName: "Vous",
        content: "J'ai suivi le brief a la lettre. Voici le document de brief original que vous m'avez envoye. Les couleurs correspondent exactement.",
        timestamp: "2026-02-21T09:30:00",
      },
      {
        id: "dm3",
        sender: "mediateur",
        senderName: "Mediateur FreelanceHigh",
        content: "Bonjour, je suis en charge de votre litige. J'ai examine les preuves des deux parties. Je vous demande un delai de 48h pour rendre ma decision.",
    ...
    evidence: [
      {
        id: "ev1",
        name: "brief-original.pdf",
        size: "1.2 MB",
        type: "pdf",
        uploadedBy: "client",
        uploadedAt: "2026-02-20T10:10:00",
      },
      {
        id: "ev2",
        name: "logo-livraison-v2.png",
        size: "3.8 MB",
        type: "image",
        uploadedBy: "freelance",
        uploadedAt: "2026-02-21T09:35:00",
      },
      {
        id: "ev3",
        name: "captures-brief.zip",
        size: "5.1 MB",
        type: "archive",
        uploadedBy: "client",
        uploadedAt: "2026-02-22T14:05:00",
      },
    ],
  },
  {
    ...
    clientAvatar: "SL",
    serviceTitle: "Site WordPress E-commerce",
    amount: 450,
    status: "resolu",
    openedAt: "2026-01-15",
    resolvedAt: "2026-02-01",
    reason: "Retard de livraison de 5 jours",
    verdict: "en_faveur_freelance",
    verdictNote: "Le jury a determine que le retard etait du a des modifications de brief par le client. Le freelance a livre dans les delais ajustes.",
    orderId: "ORD-1019",
    timeline: [
      {
        id: "tl1",
        type: "opened",
        title: "Litige ouvert",
        description: "Le client a ouvert un litige pour retard de livraison.",
      ...
      },
      {
        ...
        type: "message",
        title: "Reponse du freelance",
        description: "Vous avez explique que le retard etait lie aux changements de brief.",
      ...
      },
      {
        ...
        type: "evidence",
        title: "Preuves soumises",
        description: "Historique des messages montrant les modifications de brief.",
      ...
      },
      {
        ...
        type: "jury_assigned",
        title: "Mediateur assigne",
        description: "Un mediateur a ete assigne.",
      ...
      },
      {
        ...
        type: "verdict",
        title: "Verdict rendu",
        description: "En faveur du freelance. Les modifications de brief justifient le delai supplementaire.",
    ...
    messages: [
      {
        ...
        content: "La livraison a 5 jours de retard par rapport a la date convenue. C'est inacceptable.",
      ...
      },
      {
        ...
        sender: "freelance",
        senderName: "Vous",
        content: "Le retard est directement lie aux 3 modifications de brief que vous avez demandees en cours de route. Chaque modification a ajoute 2 jours au planning initial.",
        timestamp: "2026-01-16T10:00:00",
      },
      {
        id: "dm3",
        sender: "mediateur",
        senderName: "Mediateur FreelanceHigh",
        content: "Apres examen des echanges, les modifications de brief du client justifient le delai supplementaire. Verdict en faveur du freelance.",
        timestamp: "2026-02-01T14:00:00",
      },
    ],
    evidence: [
      {
        id: "ev1",
        name: "historique-messages.pdf",
        size: "2.3 MB",
        type: "pdf",
        uploadedBy: "freelance",
        uploadedAt: "2026-01-18T09:05:00",
      },
      {
        id: "ev2",
        name: "planning-initial.pdf",
        size: "0.5 MB",
        type: "pdf",
        uploadedBy: "freelance",
        uploadedAt: "2026-01-18T09:10:00",
      },
    ],
  },
  {
    ...
    clientAvatar: "AD",
    serviceTitle: "Redaction SEO 10 Articles",
    amount: 200,
    status: "resolu",
    openedAt: "2026-01-02",
    resolvedAt: "2026-01-20",
    reason: "Qualite insuffisante du contenu",
    verdict: "partage",
    verdictNote: "Reglement partage 50/50: le freelance a livre mais la qualite ne correspondait pas pleinement aux attentes. Remboursement partiel de 100 EUR au client.",
    orderId: "ORD-1008",
    timeline: [
      {
        id: "tl1",
        type: "opened",
        title: "Litige ouvert",
        description: "Le client a signale une qualite insuffisante.",
      ...
      },
      {
        ...
        type: "message",
        title: "Reponse du freelance",
        description: "Vous avez propose une revision supplementaire.",
      ...
      },
      {
        ...
        type: "jury_assigned",
        title: "Mediateur assigne",
        description: "Un mediateur a ete assigne au litige.",
      ...
      },
      {
        ...
        type: "verdict",
        title: "Verdict rendu",
        description: "Reglement partage 50/50. Remboursement partiel de 100 EUR.",
    ...
    messages: [
      {
        ...
        content: "Les articles livres contiennent des erreurs factuelles et le style n'est pas adapte a notre cible.",
        timestamp: "2026-01-02T16:05:00",
      },
      {
        id: "dm2",
        sender: "freelance",
        senderName: "Vous",
        content: "Je suis pret a effectuer une revision supplementaire pour corriger les points souleves. Pouvez-vous preciser les erreurs factuelles?",
        timestamp: "2026-01-03T09:00:00",
      },
      {
        id: "dm3",
        sender: "system",
        senderName: "Systeme",
        content: "Un mediateur a ete assigne a votre litige. Veuillez patienter pendant l'examen des preuves.",
        timestamp: "2026-01-10T08:00:00",
      },
      {
        id: "dm4",
        sender: "mediateur",
        senderName: "Mediateur FreelanceHigh",
        content: "Decision: reglement partage. Le freelance a livre le travail dans les delais, mais la qualite ne correspondait pas pleinement aux attentes. Remboursement partiel de 100 EUR au client.",
        timestamp: "2026-01-20T15:00:00",
      },
    ],
    evidence: [
      {
        id: "ev1",
        name: "articles-livres.zip",
        size: "4.2 MB",
        type: "archive",
        uploadedBy: "freelance",
        uploadedAt: "2026-01-02T12:00:00",
      },
      {
        id: "ev2",
        name: "brief-redaction.pdf",
        size: "0.8 MB",
        type: "pdf",
        uploadedBy: "client",
        uploadedAt: "2026-01-02T16:10:00",
      },
    ],
  },
];
