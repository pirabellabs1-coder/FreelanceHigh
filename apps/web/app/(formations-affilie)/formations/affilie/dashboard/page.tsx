    ...
    <div className="p-5 md:p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {isLoading ? (
          ...
          },
          {
            ...
            bg: "bg-amber-500/10",
            action: "/formations/affilie/retraits",
          },
        ].map((kpi, i) => (
      ...
      {(isLoading || topPages.length > 0) && (
        <div className="bg-[#0d1f17] rounded-2xl border border-[#1e3a2f] p-6 mb-8">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="/formations/affilie/performances" className="text-xs text-[#22c55e] hover:underline">
              Voir tout
            </Link>
          </div>
          {isLoading ? (
      ...
      <div className="bg-[#0d1f17] rounded-2xl border border-[#1e3a2f] p-6">
        <div className="flex items-center justify-between mb-5">
          ...
          <Link href="/formations/affilie/commissions" className="text-xs text-[#22c55e] hover:underline">
            Voir tout
          </Link>
        </div>
        {isLoading ? (
          ...
          <div className="py-10 text-center">
            ...
            <Link href="/formations/affilie/liens" className="text-xs text-[#22c55e] font-semibold hover:underline mt-2 inline-block">
              Générer des liens →
            </Link>
          </div>
        ) : (
